...
(current-keyword-list (list* "define:" "let:" "require/typed" "require/contract" ":" "→" 
                             ...
                             "define/match" "switch-compare" "T!" "t:rr" "t:question" "t:ntimes" 
                             "bit-string-case" "bit-string"
...
(current-code-tt (lambda (s) (text s (current-code-font) (+ (current-font-size) 0))))
