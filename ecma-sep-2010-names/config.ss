...
(require slideshow/code racket/require (path-up "icfp2010/lib.ss") scheme/gui (except-in (path-up "icfp2010/beamer.ss") title))
...
(current-keyword-list (list* "define:" "let:" "require/typed" "require/contract" ":" "→" 
                             ...
                             "syntax-parse" "define-matcher" "cons" "define-type" "List"
