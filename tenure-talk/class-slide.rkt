...
(require slideshow/code unstable/gui/slideshow "config.rkt" "ts-intro.rkt")
...
(define (class-slide [which #t])
  (slide #:title (title-t "What's not so good")
       #:layout 'center
       (blank 10)
       'alts
       (if (eq? which #t) stages
