#lang scheme
(require slideshow/code scheme/gui (except-in slideshow struct struct/ctc make-base-namespace make-base-empty-namespace pretty-print)
         scheme/runtime-path
...
(define (make-title-pict s)
  (let* ([ucp (colorize (text s (current-title-font) title-size) "blue")]
